                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox( height: isDesktop?20: 10 ),
                      Text(experience.title, style: TextStyle( fontSize: isDesktop?22:13, color: Colors.white ),),
                      Expanded(child: Text(experience.description, style: TextStyle( fontSize: isDesktop?18:10, color: Colors.white ), textAlign: TextAlign.center,)),
                    ],
                  ),
                )
              ],
