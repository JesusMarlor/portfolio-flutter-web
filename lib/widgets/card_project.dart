    ...
    return FadeInUp(
      child: Container(
        decoration: BoxDecoration(
          color:  AppTheme.cardBg, //Theme.of(context).highlightColor, //Theme.of(context).primaryColor,//
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    SizedBox( height: isDesktop ? 20 : 10 ),
                    Text(project.title, style: TextStyle( fontSize: isDesktop? 22 : 13, color: Colors.white ),),
                    Expanded(child: Text(project.description, style: TextStyle( fontSize: isDesktop? 18 : 10, color: Colors.white ), textAlign: TextAlign.center,)),
                  ],
                )
              ],
            )
